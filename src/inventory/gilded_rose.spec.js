...
//Does not decrease in quality when I run it (test passed)
 ...
 it('increase quality of backstage passes with decreased sell_in', ()=>{
    const standardItem = new Item('Backstage passes to a TAFKAL80ETC concert', 14, 20)
    updateQuality([standardItem])
...
it('increase quality of backstage passes with decreased sell_in', ()=>{
    const standardItem = new Item('Backstage passes to a TAFKAL80ETC concert', 10, 20)
    updateQuality([standardItem])
  ...
  //quality increases by 2 when there are 10 days or less
it('increase quality of backstage passes with decreased sell_in', ()=>{
    const standardItem = new Item('Backstage passes to a TAFKAL80ETC concert',  9, 20)
    updateQuality([standardItem])
    expect(standardItem.quality).toBe(22)
  });
  ...
  it('increase quality of backstage passes with decreased sell_in', ()=>{
    const standardItem = new Item('Backstage passes to a TAFKAL80ETC concert',  5, 20)
    updateQuality([standardItem])
    ...
    //quality increases by 3 when there are 5 days or less
  it('increase quality of backstage passes with decreased sell_in', ()=>{
    const standardItem = new Item('Backstage passes to a TAFKAL80ETC concert',  3, 20)
    updateQuality([standardItem])
    expect(standardItem.quality).toBe(23)
  });
  ...
  //   const standardItem = new Item('Conjured Mana Cake', 3, -6)
  //   updateQuality([standardItem])

  //   expect(standardItem.quality).toEqual(-7)
  // });
